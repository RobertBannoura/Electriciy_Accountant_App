            ...
            return (
              <article className="rounded-2xl border-2 border-slate-200 p-4" key={payment.id}>
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  ...
                  ) : <label><span className="mb-2 block font-black">المبلغ بالشيكل</span><input className={inputClass} inputMode="decimal" onChange={(event) => update(payment.id, { amount: event.target.value })} value={payment.amount} /></label>}
